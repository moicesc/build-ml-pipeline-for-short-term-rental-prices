...
def go(config: DictConfig):
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        if "basic_cleaning" in active_steps:
            logger.info("Step: Basic Cleaning")
            _ = mlflow.run(
                ...
                parameters={
                    ...
                    "output_description": "dataset with outliers and"
                                          " null values removed",
        ...
        if "train_random_forest" in active_steps:
            ...
            with open(rf_config, "w+") as fp:
                json.dump(dict(config["modeling"]["random_forest"].items()), fp)  # DO NOT TOUCH # noqa
        ...
        if "test_regression_model" in active_steps:
            logger.info("Step: Test Regression Model")
